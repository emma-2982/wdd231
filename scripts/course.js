...
// Select course list container
const courseContainer = document.querySelector("#list");

// Select credits paragraph
const creditText = document.querySelector("#text");
...
function displayCourses(courseArray) {
    ...
    creditText.textContent =
        `The total credits for the course listed above is ${totalCredits}`;
}
